...
ADD COLUMN IF NOT EXISTS ai_insights_source VARCHAR(20) DEFAULT 'fallback' CHECK (ai_insights_source IN ('ai', 'fallback'));

-- Recreate the recent_assessments view with AI insights columns
